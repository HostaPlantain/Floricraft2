...
public interface IModule {
	...
	public default IRecipe shapedRecipe(String group, Item result, Object... recipe)	{return shapedRecipe(group, new ItemStack(result), recipe);}
	public default IRecipe shapedRecipe(String group, Block result, Object... recipe){return shapedRecipe(group, new ItemStack(result), recipe);}	
	...
	public default IRecipe shapelessRecipe(String group, Item result, Object... recipe)	{return shapelessRecipe(group, new ItemStack(result), recipe);}
	public default IRecipe shapelessRecipe(String group, Block result, Object... recipe)	{return shapelessRecipe(group, new ItemStack(result), recipe);}
	...
	public default IRecipe compressRecipe(String group, Item result, ItemStack item, boolean isNine)	{return compressRecipe(group, new ItemStack(result), item, isNine);}
	public default IRecipe compressRecipe(String group, Block result, ItemStack item, boolean isNine)	{return compressRecipe(group, new ItemStack(result), item, isNine);}
