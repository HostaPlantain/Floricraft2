...
public class ItemBaseFoodMeta extends ItemBaseFood implements IMetaName {

	private final String[] SUB_ID;

	public ItemBaseFoodMeta(String unlocalizedName, String[] subName, int amount, float saturation, boolean isWolfFood)
	{
